...
<section class="hero-section text-left" <?php if ($hero_background) echo 'style="background-image: url(' . esc_url($hero_background) . ')"'; ?>>
    <div class="container">
    <?php if (get_theme_mod('amt_hero_title_enabled', true)) {?>
        <div class="hero-content">
            <h1><?php echo esc_html($hero_title); ?></h1>
            <p><?php echo esc_html($hero_text); ?></p>
            <a href="<?php echo esc_url($hero_button_link); ?>" class="btn btn-secondary btn-wide text-decoration-none"><?php echo esc_html($hero_button_text); ?></a>
        </div>
        <?php }?>
    </div>
</section>